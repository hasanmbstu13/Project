...
$users = $t1->getDataFromAPI(array('connection'=>'friends/list', 'params'=>$params));
...
if($next_cursor>0) echo '<div id="displayMoreTwtFriendsBox"><a href="#" class="btn" id="display_more_twt_friends_btn" data-next-cursor="'.$next_cursor.'" class="btn">Load more</a></div>';
