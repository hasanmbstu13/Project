  ...
  public function __construct($config=array()) {
    ...
    $this->config = array_merge(
      array(
        ...
        'curl_ssl_verifypeer'        => $GLOBALS['twt_curl_ssl_verifypeer'],
    ...
    switch ($this->method) {
      ...
      default:
        ...
        if ( ! empty($this->request_params)) {
          ...
          // $this->url = "https://api.twitter.com/1.1/statuses/home_timeline.json?count=20&user_id=3225959616";
          // $this->url = "https://api.twitter.com/1.1/search/tweets.json?q=%23freebandnames&since_id=24012619984051000&max_id=250126199840518145&result_type=mixed&count=4";
          // $this->url = "https://api.twitter.com/1.1/search/tweets.json?count=20&q=%23iteachmath";
          // echo $this->url; exit;
          // echo $this->url;
