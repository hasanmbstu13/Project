...
/*-------- CONFIGURE THESE --- Instagram API KEYS Musa Vai--------*/	
define("clientID"       ,	 'bb448574b2284687ac003df441a92817'); 			//associated your developer account with this program
define("clientSecret"   ,	 '2e41507c6f7f46d2b64106ad527d319e'); 			//password
define("redirectURI"    ,	 'http://localhost/InstagramPhotoDownloader/index.php'); 		//after users choose whether to let you use access account or not (must match the one you registered)
...
// logged in
	...
	printImages($results['user']['id'],$results['access_token']);
