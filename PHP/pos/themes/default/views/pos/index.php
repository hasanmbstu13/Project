			...
			<nav class="navbar navbar-static-top" role="navigation">
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<li><a href="#" onClick="MyWindow=window.open('/pos/register_details', 'MyWindow','toolbar=no,location=no,directories=no,status=no,menubar=yes,scrollbars=yes,resizable=yes,width=350,height=600'); return false;" title='Print Register'><?= lang('register_details'); ?></a></li>
						<?php if($Admin) { ?>
						...
						<ul class="treeview-menu">
							...
							<li class="treeview mm_purchases">
			                    ...
			                    <ul class="treeview-menu">
			                        ...
			                        <li class="divider"></li>
									<li id="purchases_withdraws"><a href="<?= site_url('purchases/withdraws'); ?>"><i class="fa fa-circle-o"></i> <?= lang('list_withdraws'); ?></a></li>
			                        <li id="purchases_add_withdraw"><a href="<?= site_url('purchases/add_withdraw'); ?>"><i class="fa fa-circle-o"></i> <?= lang('add_withdraw'); ?></a></li>
			                    </ul>
			                </li>
							...
							<li class="treeview" id="mm_reports">
								...
								<ul class="treeview-menu">
									...
									<li id="comprehensive_sales_report"><a href="<?= site_url('reports/comprehensive_sales_report'); ?>"><i class="fa fa-circle-o"></i> <?= lang('comprehensive_sales_report'); ?></a></li>
									<li id="reports_products_history"><a href="<?= site_url('reports/products_history'); ?>"><i class="fa fa-circle-o"></i> <?= lang('Products_stock_report'); ?></a></li>
									<li class="divider"></li>
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<select id="paid_by" class="form-control paid_by select2" style="width:100%;">
										...
										<option value="CreditCard"><?= lang("cc"); ?></option>
										<!-- <option value="CC"><?= lang("cc"); ?></option> -->
										<option value="cheque"><?= lang("cheque"); ?></option>
										<!-- <option value="Cheque"><?= lang("Cheque"); ?></option> -->
										<option value="gift_card"><?= lang("gift_card"); ?></option>
<!--
										<?php//= isset($Settings->stripe) ? '<option value="stripe">' . lang("stripe") . '</option>' : ''; ?>
-->
									</select>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="pcheque" style="display:none;">
								<div class="form-group"><?= lang("cheque_no"); ?>
									...
									class="form-control Cheque_no kb-pad Cheque_input kb-text"/>
								</div>
							</div>
						</div>
					</div>
