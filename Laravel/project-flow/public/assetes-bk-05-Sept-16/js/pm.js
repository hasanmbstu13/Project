...
*/
    ...
    //     if (!$(e.target).is('.popper, .popover-title, .popover-content')) {
    //         $('.popper').popover('hide');
    //     }
    // });
    ...
    // .on('click', 'body .removePopover',function(e){
   ...
   // This method will load dynamiccontent after successful brief creation 
    ...
    // $('#client_brief').on('submit', function(e) {
